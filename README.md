...
所以我的想法是，我知道 List<SetmealDto> list = dtoPage.getRecords() list里面的范型实际上是Setmeal类型的，but why it hurts?

正确解法这里是这样写的：List<Setmeal> list = pageInfo.getRecords()，得到的list的范型也是Setmeal，那么我的解法为什么不行呢？
